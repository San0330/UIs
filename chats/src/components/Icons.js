const Icons = ({ name, active = false, size = 'md' }) => {
    ...
    switch (name) {
        ...
        case 'message':
            ...
            break;
        case 'calendar':
            icon = <svg className='mx-auto' width={`${width}`} height={`${height}`} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2" /><line x1="16" y1="2" x2="16" y2="6" /><line x1="8" y1="2" x2="8" y2="6" /><line x1="3" y1="10" x2="21" y2="10" /></svg>
            break;
        case 'notification':
            icon = <svg className='mx-auto' width={`${width}`} height={`${height}`} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9" /><path d="M13.73 21a2 2 0 0 1-3.46 0" /></svg>
            break;
        case 'settings':
